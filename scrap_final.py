...
try:
    ...
    # base_url = "https://finance.yahoo.com/quote/HSY/history?period1={}&period2={}&interval=1d&filter=history&frequency=1d&includeAdjustedClose=true"
    base_url = "https://finance.yahoo.com/quote/JPM/history?period1={}&period2={}&interval=1d&filter=history&frequency=1d&includeAdjustedClose=true"
